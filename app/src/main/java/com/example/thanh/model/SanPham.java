...
public class SanPham {
    ...
    public SanPham(int maSp, String tenSp, int maNcc, int maLoai, int soLuongTon, String anhBia, String giaBan, String baoHanh, String moTa, String ngayCapNhat, int slBanRa, String tongDanhGia) {
        this.maSp = maSp;
        this.tenSp = tenSp;
        this.maNcc = maNcc;
        this.maLoai = maLoai;
